...
export function SingleTask({
  xScale, answer, name, height, setSelectedTask, isSelected, labelHeight = 0, isCorrect, hasCorrect, showLabel,
} : {answer: StoredAnswer, name: string, height: number, xScale: d3.ScaleLinear<number, number>, setSelectedTask: (task: string) => void, isSelected: boolean, labelHeight?: number, isCorrect: boolean, hasCorrect: boolean, showLabel: boolean}) {
