...
export function StepRenderer() {
  ...
  // @ts-ignore
  const sidebarOpen = useMemo(() => (((analysisHasScreenRecording && analysisCanPlayScreenRecording) || currentComponent === 'end') ? false : ((componentConfig.withSidebar || componentConfig.sidebar) ?? (studyConfig.uiConfig.withSidebar || studyConfig.uiConfig.sidebar))), [analysisHasScreenRecording, analysisCanPlayScreenRecording, currentComponent, componentConfig.withSidebar, componentConfig.sidebar, studyConfig.uiConfig.withSidebar, studyConfig.uiConfig.sidebar]);
